  ...
  if (params.loopFillGroupWithBlank) {
    ...
    if (blankSlidesNum !== params.slidesPerGroup) {
      for (let i = 0; i < blankSlidesNum; i += 1) {
        const blankNode = (0, _dom.$)(doc.createElement('div')).addClass(`${params.slideClass} ${params.slideBlankClass}`);
...
// Swiper Class
// Core Modules
const components = [Device$2, Support$2, Browser, Resize, Observer$1, Virtual$1, Keyboard$1, Mousewheel$1, Navigation$1, Pagination$1, Scrollbar$1, Parallax$1, Zoom$1, Lazy$1, Controller$1, A11y, History$1, HashNavigation$1, Autoplay$1, EffectFade, EffectCube, EffectFlip, EffectCoverflow];
...
},{"dom7/dist/dom7.modular":3}],1:[function(require,module,exports) {
...
view.Swiper = view.Swiper || _swiper2.default;
...
if (!module.bundle.parent && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket('ws://' + hostname + ':' + '55570' + '/');
...
//# sourceMappingURL=/dist/wp-swiper-shortcode.map