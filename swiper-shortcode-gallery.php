...
function wp_swiper_shortcode_gallery($attr = array(), $content = "") {
  global $post;
  $output = "";
...
function wp_swiper_shortcode_post_gallery($content, $atts) {
  return wp_swiper_shortcode_gallery($atts, $content);
}
add_filter( 'post_gallery', 'wp_swiper_shortcode_post_gallery', 10, 2 );
